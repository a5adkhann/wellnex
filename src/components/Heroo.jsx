...
const Heroo = () => {
  return (
    ...
    >
      ...
      {/* Hero Content */}
      <div className="flex items-center justify-center min-h-screen px-6 md:px-12 lg:px-20">
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 items-center gap-10">
          
          {/* Left Side */}
          <div className="text-center md:text-left space-y-6">
            {/* Headline */}
            <h1 className="text-5xl sm:text-6xl lg:text-7xl font-bold font-poppins leading-tight bg-clip-text text-transparent bg-gradient-to-r from-white via-[#D4F4E2] to-[#34C759] drop-shadow-lg">
              Wellnex Systems
            </h1>

            {/* Animated Text */}
            <motion.div
              className="text-2xl sm:text-3xl text-[#E6F0FA]/90 font-light font-inter"
            ...
            {/* Description */}
            <motion.p
              className="text-base sm:text-lg text-gray-100/90 max-w-2xl mx-auto md:mx-0 leading-relaxed tracking-wide font-inter"
              initial={{ opacity: 0, y: 10 }}
              whileInView={{ opacity: 1, y: 0 }}
            ...
            {/* Badge */}
            <motion.div
              className="inline-block bg-[#34C759] text-white px-5 py-2 rounded-full text-sm font-semibold font-inter shadow-lg"
              initial={{ opacity: 0 }}
            ...
            <div className="flex flex-col sm:flex-row justify-center md:justify-start gap-4 pt-6">
              <a
                href="#join"
                className="bg-gradient-to-r from-[#34C759] to-[#2ca44e] text-white px-8 py-3 rounded-full font-semibold text-base font-poppins shadow-md hover:shadow-xl hover:scale-105 transition-all duration-200"
              >
                Join the Movement
              </a>
              <a
                href="#apps"
                className="border-2 border-[#D4F4E2] text-[#D4F4E2] px-8 py-3 rounded-full font-semibold text-base font-poppins hover:bg-[#D4F4E2] hover:text-[#007BFF] hover:shadow-xl transition-all duration-200"
              >
                Explore Our Apps
              </a>
            </div>
          ...
          <div className="hidden md:flex justify-center items-center relative">
            <div className="relative flex justify-center items-center w-[320px] h-[320px]">
              ...
              <MdOutlineSelfImprovement className="text-[300px] text-[#D4F4E2]/70" />
            </div>
          </div>
        </div>
      </div>
